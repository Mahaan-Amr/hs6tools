    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-black via-gray-900 to-primary-black pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h2 className="text-3xl font-bold text-white mb-6">تاریخچه شرکت</h2>
          ...
          <div className="glass rounded-3xl p-8 text-center">
            ...
            <h3 className="text-2xl font-semibold text-white mb-4">۱۵+ سال تجربه</h3>
            <p className="text-gray-300">در تولید ابزارهای صنعتی</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass rounded-3xl p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">کیفیت تضمین شده</h3>
            <p className="text-gray-300">تمام محصولات ما با بالاترین استانداردهای کیفیت تولید می‌شوند</p>
          </div>
          
          <div className="glass rounded-3xl p-8 text-center">
            <div className="w-20 h-20 bg-gradient-to-r from-green-500 to-green-600 rounded-2xl mx-auto mb-6 flex items-center justify-center">
              <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-white mb-4">تکنولوژی پیشرفته</h3>
            <p className="text-gray-300">استفاده از جدیدترین تکنولوژی‌ها در تولید ابزارهای صنعتی</p>
          </div>
          ...
          <div className="glass rounded-3xl p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">پشتیبانی 24/7</h3>
            <p className="text-gray-300">پشتیبانی کامل و مشاوره تخصصی در تمام ساعات شبانه‌روز</p>
          </div>
        </div>
      </div>
    </div>
