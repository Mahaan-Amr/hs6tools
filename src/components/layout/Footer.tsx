        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              {/* Social Media Links */}
              <a href="#" className="w-10 h-10 glass rounded-xl flex items-center justify-center text-gray-700 dark:text-white/80 hover:text-gray-900 dark:hover:text-white transition-colors duration-200">
