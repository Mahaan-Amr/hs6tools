  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col min-h-screen">
        {/* Header */}
        <header
          className="glass border-b border-white/10 backdrop-blur-xl relative admin-header shadow-2xl border-l-4 border-l-primary-orange"
          style={{ zIndex: 10000 }}
        >
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 gap-4">
            <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0 min-w-0">
              ...
              <button
                ...
                title={String(
                  messages?.admin?.crm?.adminLayout?.openMenu || "باز کردن منو",
                )}
                aria-label={String(
                  messages?.admin?.crm?.adminLayout?.openMenu || "Open menu",
                )}
              >
                <svg
                  className="w-6 h-6"
              ...
              <h1 className="text-base sm:text-lg lg:text-xl font-semibold text-white truncate">
                {String(
                  messages?.admin?.crm?.adminLayout?.title || "پنل مدیریت",
                )}
              </h1>
            </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 flex-shrink-0">
              ...
              <button
                ...
                aria-label={
                  isRightSidebarCollapsed
                    ? String(
                        messages?.admin?.crm?.adminLayout?.openMenu ||
                          "Open menu",
                      )
                    : String(
                        messages?.admin?.crm?.adminLayout?.closeMenu ||
                          "Close menu",
                      )
                }
              >
              ...
              <Link
                ...
                title={String(
                  messages?.admin?.crm?.adminLayout?.backToSite ||
                    "بازگشت به سایت",
                )}
              >
                <svg
              ...
              <button
                ...
                title={String(
                  messages?.admin?.crm?.adminLayout?.logout ||
          ...
          >
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.dashboard ||
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.products ||
                      messages?.admin?.products ||
                      "محصولات",
                  )}
                </span>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.categories ||
            ...
            >
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-medium">
                    {String(
                      messages?.admin?.crm?.adminLayout?.orders ||
                        messages?.admin?.orders ||
                        "سفارشات",
                    )}
                  </span>
                </div>
                <span className="px-2 py-1 bg-primary-orange text-white text-xs rounded-full">
                  12
                </span>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.users ||
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">{adminCopy.support}</span>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.content ||
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.analytics ||
                      messages?.admin?.analytics ||
                      "گزارش‌ها",
                  )}
                </span>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.customerManagement ||
                      messages?.admin?.crm?.customerManagement ||
                      "مدیریت مشتریان",
                  )}
                </span>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.customerLifecycle ||
                      messages?.admin?.crm?.customerLifecycle ||
                      "چرخه زندگی مشتری",
                  )}
                </span>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.leadManagement ||
                      messages?.admin?.crm?.leadManagement ||
                      "مدیریت لیدها",
                  )}
                </span>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.quotes ||
                      messages?.admin?.crm?.quotesLabel ||
                      "پیشنهادات",
                  )}
                </span>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">
                  {String(
                    messages?.admin?.crm?.adminLayout?.settings ||
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-white/60 text-xs truncate">
                  {session?.user?.role === "SUPER_ADMIN"
                    ? String(
                        messages?.admin?.crm?.adminLayout?.superAdmin ||
                          "Super Admin",
                      )
                    : String(
                        messages?.admin?.crm?.adminLayout?.admin || "Admin",
                      )}
                </p>
              </div>
            </div>
      ...
      {isRightSidebarCollapsed && (
        <button
          ...
          title={String(
            messages?.admin?.crm?.adminLayout?.toggleMenu ||
              messages?.admin?.crm?.adminLayout?.showMenu ||
              "نمایش منو",
          )}
          style={{ zIndex: 10002 }}
        >
