            ...
            <div className="glass rounded-3xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-gray-900 dark:text-white font-semibold">آدرس</h3>
                    <p className="text-gray-600 dark:text-gray-300">تهران، خیابان ولیعصر، پلاک ۱۲۳</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-gray-900 dark:text-white font-semibold">تلفن</h3>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-gray-900 dark:text-white font-semibold">ایمیل</h3>
                    <p className="text-gray-600 dark:text-gray-300">info@hs6tools.com</p>
                  </div>
                </div>
              </div>
            </div>
