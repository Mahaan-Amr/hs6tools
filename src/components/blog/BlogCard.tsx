...
export default function BlogCard({ article }: BlogCardProps) {
  ...
  const getCategoryColor = (categoryName: string) => {
    const colors = {
      ...
      "نجاری": "bg-blue-500/20 text-blue-500",
      "ایمنی": "bg-green-500/20 text-green-500",
      "نوآوری": "bg-purple-500/20 text-purple-500",
      "آموزش": "bg-yellow-500/20 text-yellow-500",
      "تست": "bg-red-500/20 text-red-500",
    };
