        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              {/* Rubika Link */}
              <a
                href="https://rubika.ir/page/Hs6tools"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 glass rounded-xl flex items-center justify-center text-gray-700 dark:text-white/80 hover:text-white hover:bg-gradient-to-r hover:from-cyan-500 hover:to-blue-500 transition-all duration-200"
                aria-label="Rubika"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M12 2.25 4.25 6.7v8.92L12 20.08l7.75-4.46V6.7L12 2.25Zm0 2.78 5.35 3.07v6.12L12 17.3l-5.35-3.08V8.1L12 5.03Zm0 3.03-2.72 1.56v3.13L12 14.31l2.72-1.56V9.62L12 8.06Z" />
                </svg>
              </a>
            </div>
          </div>
