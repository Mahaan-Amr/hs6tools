...
export async function GET() {
  try {
    ...
    diagnostics.envCheck = {
      ...
      SMSIR_SIGNUP_VERIFY_TEMPLATE_ID: process.env.SMSIR_SIGNUP_VERIFY_TEMPLATE_ID || "NOT SET",
      SMSIR_WELCOME_SIMPLE_TEMPLATE_ID: process.env.SMSIR_WELCOME_SIMPLE_TEMPLATE_ID || "NOT SET",
      SMSIR_WELCOME_INFO_TEMPLATE_ID: process.env.SMSIR_WELCOME_INFO_TEMPLATE_ID || "NOT SET",
      SMSIR_LOGIN_OTP_TEMPLATE_ID: process.env.SMSIR_LOGIN_OTP_TEMPLATE_ID || "NOT SET",
      SMSIR_PASSWORD_RESET_TEMPLATE_ID: process.env.SMSIR_PASSWORD_RESET_TEMPLATE_ID || "NOT SET",
      SMSIR_PURCHASE_CONFIRMED_TEMPLATE_ID: process.env.SMSIR_PURCHASE_CONFIRMED_TEMPLATE_ID || "NOT SET",
      SMSIR_INVOICE_TEMPLATE_ID: process.env.SMSIR_INVOICE_TEMPLATE_ID || "NOT SET",
      SMSIR_POST_TRACKING_TEMPLATE_ID: process.env.SMSIR_POST_TRACKING_TEMPLATE_ID || "NOT SET",
      SMSIR_ORDER_PROCESSING_TEMPLATE_ID: process.env.SMSIR_ORDER_PROCESSING_TEMPLATE_ID || "NOT SET",
