    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-black via-gray-900 to-primary-black flex items-center justify-center" style={{ zIndex: 9999 }}>
        <div className="text-center">
          ...
          <p className="text-white text-lg">{copy.checkingAccess}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-black via-gray-900 to-primary-black flex items-center justify-center" style={{ zIndex: 9999 }}>
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">{copy.unauthorized}</h1>
          <p className="text-gray-300 mb-6">{copy.unauthorizedDescription}</p>
          <button
